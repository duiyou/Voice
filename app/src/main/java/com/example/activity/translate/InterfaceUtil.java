...
public class InterfaceUtil {
    ...
    public static synchronized InterfaceUtil getInstance(TranslateActivity translateActivity){
        if(instance == null)instance = new InterfaceUtil(translateActivity);
        return instance;
    }
    //私有构造器
    private InterfaceUtil(TranslateActivity translateActivity){
    ...
    private void initBackgroundUtil(){
        this.backgroundUtil = BackgroundUtil.getInstance(translateActivity);
    ...
    class MyBackgroundUtilListener implements BackgroundUtil.BackgroundUtilListener{
            ...
            if(finalResult != null && !finalResult.isEmpty()){
                ...
                if(backgroundUtil != null){
                    if(translateWay == TRANSLATEWAY_C_TO_E){
                        backgroundUtil.translate(finalResult , BackgroundUtil.TRANSLATEWAY_C_TO_E);
                    }else{
                        backgroundUtil.translate(finalResult , BackgroundUtil.TRANSLATEWAY_E_TO_C);
                    }
                }
            }else{
                //不去翻译证明结束流程，重置
        ...
        public void wellTranslate(String result) {
            if(result != null && !result.isEmpty()){
                ...
                /***********翻译出错****************/
                Log.e(TAG, "wellTranslate: 翻译为空了，哪里出错了");
            }
    ...
    private void startUI(){
       ...
       if(!isUIStart){
           ...
           if (speechButton != null) {
               ...
               speechButton.setBackground(translateActivity.getResources().getDrawable(R.drawable.translate_activity_speechbutton_backgroundpress));
           }
       }
    }
    ...
    private void stopUI(){
       ...
       if(isUIStart){
           ...
           if (speechButton != null) {
               ...
               speechButton.setBackground(translateActivity.getResources().getDrawable(R.drawable.translate_activity_speechbutton_backgrounddefault));
           }
       }
    }
