...
public class MsgAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case Msg.TYPE_SEND:
                //创建视图
                mView= LayoutInflater.from(parent.getContext()).inflate(R.layout.translate_activity_listuser, parent, false);
                //创建ViewHolder并传入视图
                mViewHolder = new SendViewHolder(mView);
                return mViewHolder;
            case Msg.TYPE_RECEIVED:
                //创建视图
                mView= LayoutInflater.from(parent.getContext()).inflate(R.layout.translate_activity_listtranslate, parent, false);
                //创建ViewHolder并传入视图
